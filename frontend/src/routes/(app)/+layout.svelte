			...
			transition-all duration-150 cursor-pointer"
				...
				{#if data?.user?.is_admin && data?.settings?.show_get_started !== false}
					<button
						...
						class="shrink-0 px-3 py-1.5 rounded-full text-white text-xs font-semibold shadow-lg
			ring-2 ring-offset-2 transition-all duration-300 cursor-pointer
			bg-secondary-500 ring-secondary-400 hover:bg-secondary-600
			hover:ring-secondary-300 hover:ring-offset-secondary-100 hover:shadow-secondary-500/50
			focus:outline-hidden focus:ring-secondary-500"
					>
